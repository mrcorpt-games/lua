local Arqel = loadstring(game:HttpGet("https://raw.githubusercontent.com/mrcorpt-games/lua/refs/heads/main/NexoUi.lua"))()

Arqel.Appearance.Title = "Nexo Hub"
Arqel.Appearance.Icon = "rbxassetid://1"
Arqel.Links.Discord = "Discord.gg/nexohub"
